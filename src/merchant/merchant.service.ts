...
export class MerchantService {
	...
	async findOne(id: string) {
		try {
			...
			throw new InternalServerErrorException(`Failed to retrieve merchant with ID ${id}`);
		}
	}
	...
	async update(id: string, updateMerchantDto: UpdateMerchantDto) {
		try {
			...
			throw new InternalServerErrorException(`Failed to update merchant with ID ${id}`);
		}
	}
	...
	async remove(id: string) {
		try {
			...
			throw new InternalServerErrorException(`Failed to delete merchant with ID ${id}`);
		}
	}
}
